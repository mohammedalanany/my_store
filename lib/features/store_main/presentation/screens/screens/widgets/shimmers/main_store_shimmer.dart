...
class MainStoreShimmer extends StatelessWidget {
 final String? title;
 MainStoreShimmer({this.title,});
  @override
                  ...
                  Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text('TruSkin Vitamin C Serum for Face, Anti Aging Serum',
